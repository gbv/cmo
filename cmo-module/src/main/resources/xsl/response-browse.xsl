      ...
      <tr>
        ...
        <td>
          <xsl:variable name="params">
            <xsl:for-each select="lst[@name='responseHeader']/lst[@name='params']/*[not(@name='rows' or @name='XSL.Style' or @name='fl' or @name='start')]">
              <xsl:choose>
              ...
              <!-- ParameterName=origParameterValue -->
                  ...
                  <xsl:value-of select="concat(substring-after(@name, 'orig'),'=', .)" />

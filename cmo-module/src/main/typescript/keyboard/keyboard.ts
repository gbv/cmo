...
const KEYBOARD_ENTRIES: KeyboardTab[] = [
    {
        ...
        entries: [
            ...
            {character: {uppercase: ["ᴕ̲"], lowercase: ["ᴕ̲"]}},
    ...
    },
    {
        ...
        entries: [
            ...
            {character: {uppercase: ["Ȏ"], lowercase: ["ȏ"]}},
            {character: {uppercase: ["Ȏ̲"], lowercase: ["ȏ̲"]}},
            ...
            {character: {uppercase: ["Ṡ"], lowercase: ["ṡ"]}},
            ...
            {character: {uppercase: ["U̇"], lowercase: ["u̇"]}},
            {character: {uppercase: ["U̲̇"], lowercase: ["u̲̇"]}},
            ...
            {character: {uppercase: ["Ǔ"], lowercase: ["ǔ"]}},
            {character: {uppercase: ["Ǔ̲"], lowercase: ["ǔ̲"]}},
            {character: {uppercase: ["Ů"], lowercase: ["ů"]}},
            {character: {uppercase: ["Ů̲"], lowercase: ["ů̲"]}},
            {character: {uppercase: ["Ų"], lowercase: ["ų"]}},
            {character: {uppercase: ["Ų̲"], lowercase: ["ų̲"]}},
            {character: {uppercase: ["Ȗ"], lowercase: ["ȗ"]}},
            {character: {uppercase: ["Ȗ̲"], lowercase: ["ȗ̲"]}},
